 ...
 * across games within the same running client. Add future lobby options here (e.g. max
 * players, starting level) — {@code LobbySettingsScreen} builds one control per field the
 * same way.
 */
